...
flags.DEFINE_string('save_directory', '', 'directory for save output.')
...
flags.DEFINE_integer('print_every', 100, "How often to print training info.") #defult 50
...
def log_dir():
    ...
    #log_dir = FLAGS.base_log_dir + "/unsup-embedding/" + FLAGS.train_prefix[80:-36] # specices should be human
    #print('train is ',FLAGS.train_prefix[80:-36]) #
    #print('train is ',FLAGS.train_prefix[-4:])
    log_dir = FLAGS.base_log_dir + "/unsup-embedding/" + FLAGS.save_directory
...
def save_val_embeddings(sess, model, minibatch_iter, size, out_dir, mod=""):
    ...
    iter_num = 0
    #name = "val"
    name = FLAGS.train_prefix[-37:] # this name is name of PPI 
    print ('name is ',name)
    #print("flag prefix is",FLAGS.train_prefix[12:])
    while not finished:
