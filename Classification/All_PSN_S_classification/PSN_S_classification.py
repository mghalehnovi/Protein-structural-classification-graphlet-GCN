...
######Approache 1: PSN, Ordergraphlet3-4##################
   # print "Approache 1"
   # Feature_selected = "orderedgraphlet-3-4" 
   # Order = True
   # for level in levels:
     # print level 
     # X, Y = PSN_Graphlet(Feature_selected,Order)
     # LR_classification(X,Y, sampling_type=0)

######Approache 2: PSN, graphlet-3-4##################
   # print "Approache 2"
   # Feature_selected = "graphlet-3-4"#, "graphlet-3-5"
   # Order = False
   # for level in levels:
       # print level
       # #X, Y = PSN_Graphlet(Feature_selected,Order)
...
# ######Approache 3: PSN, graphlet-3-5##################
   # print "Approache 3"
   # Feature_selected = "graphlet-3-5"#, "graphlet-3-5"
   # Order = False
   # for level in levels:
       # print level
       # #X, Y = PSN_Graphlet(Feature_selected,Order)
...
# ######Approache 4: PSN, GCN embedding, initial feature: None##################
   # print "Approache 4"
...
# # ######Approache 5: PSN, GCN embedding, initial feature: GDV_matrix (ORCA)##################
   # print "Approache 5"
   # models = ["graphsage_mean",'graphsage_maxpool', 'graphsage_meanpool','graphsage_seq','gcn'] 
...
# ######Approache 6: PSN, Ordergraphlet3-4 + GCN embedding, initial feature: None##################
   # print "Approache 6"
   # Feature_selected = "orderedgraphlet-3-4" 
   # models = ["graphsage_mean",'graphsage_maxpool', 'graphsage_meanpool','graphsage_seq','gcn'] 
   # level_all = "Nofeature_AllPSN4_LCC_128"
   # for level in levels:
       # print level
       # X_Graphlet, Y = Read_Data_for_LR()
       # data_directory_save_gcn = os.path.join(ROOT_PATH,'GCN_embedding_features',species,level_all,level)   
       # for model in models:
           # print model
           # X_GCN = np.loadtxt(data_directory_save_gcn+'/'+level+'_'+model+'.txt')
           # feat_concat = np.column_stack((X_Graphlet,X_GCN))
           # LR_classification(feat_concat,Y, sampling_type=0)
   
# ######Approache 7: PSN, Ordergraphlet3-4 + GCN embedding, initial feature: GDV_matrix (ORCA)##################
   # print "Approache 7"
   # Feature_selected = "orderedgraphlet-3-4" 
   # models = ["graphsage_mean",'graphsage_maxpool', 'graphsage_meanpool','graphsage_seq','gcn'] 
   # level_all = "Feature_orca_AllPSN4_LCC_128"
...
# ######Approache 8: PSN, graphlet-3-4 + GCN embedding, initial feature: None##################
   # print "Approache 8"
...
# ######Approache 9: PSN, graphlet3-4 + GCN embedding, initial feature: GDV_matrix (ORCA)##################
   # print "Approache 9"
   # Feature_selected = "graphlet-3-4" 
   # models = ["graphsage_mean",'graphsage_maxpool', 'graphsage_meanpool','graphsage_seq','gcn'] 
   # level_all = "Feature_orca_AllPSN4_LCC_128"
...
# ######Approache 10: PSN, graphlet-3-5 + GCN embedding, initial feature: None##################
   # print "Approache 10"
...
# ######Approache 11: PSN, graphlet3-5 + GCN embedding, initial feature: GDV_matrix (ORCA)##################
   # print "Approache 11"
   # Feature_selected = "graphlet-3-5" 
   # models = ["graphsage_mean",'graphsage_maxpool', 'graphsage_meanpool','graphsage_seq','gcn'] 
   # level_all = "Feature_orca_AllPSN4_LCC_128"
